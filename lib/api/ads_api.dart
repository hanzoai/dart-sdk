...
class AdsApi {
  ...
  ///
  /// * [String] id (required):
  Future<Response> deleteAdsCampaignsByIdWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/ads/campaigns/{id}'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [String] id (required):
  Future<void> deleteAdsCampaignsById(String id,) async {
    final response = await deleteAdsCampaignsByIdWithHttpInfo(id,);
  ...
  Future<Response> getAdsCampaignsWithHttpInfo({ String? status, int? limit, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/ads/campaigns';
  ...
  /// * [int] limit:
  ///   Limit caps how many campaigns come back: default 200, maximum 1000. A value that is not a positive integer reads as the default.
  Future<CampaignList?> getAdsCampaigns({ String? status, int? limit, }) async {
    final response = await getAdsCampaignsWithHttpInfo( status: status, limit: limit, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  ...
  ///
  /// * [String] id (required):
  Future<Response> getAdsCampaignsByIdWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/ads/campaigns/{id}'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [String] id (required):
  Future<AdCampaign?> getAdsCampaignsById(String id,) async {
    final response = await getAdsCampaignsByIdWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// Note: This method returns the HTTP [Response].
  Future<Response> getAdsSummaryWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/v1/ads/summary';
  ...
  ///
  /// Rolls the caller org's ad campaigns up into four numbers: how many campaigns exist, how many are active, and the summed budget and spend across all of them. Budget and spend are MINOR units (cents), the same units the campaign rows carry. It counts only this org's campaigns.
  Future<AdSummary?> getAdsSummary() async {
    final response = await getAdsSummaryWithHttpInfo();
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postAdsCampaignsWithHttpInfo(CampaignInput campaignInput,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/ads/campaigns';
  ...
  ///
  /// * [CampaignInput] campaignInput (required):
  Future<AdCampaign?> postAdsCampaigns(CampaignInput campaignInput,) async {
    final response = await postAdsCampaignsWithHttpInfo(campaignInput,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [String] id (required):
  Future<Response> postAdsCampaignsByIdLaunchWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/ads/campaigns/{id}/launch'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [String] id (required):
  Future<void> postAdsCampaignsByIdLaunch(String id,) async {
    final response = await postAdsCampaignsByIdLaunchWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putAdsCampaignsByIdWithHttpInfo(String id, UpdateCampaignIn updateCampaignIn,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/ads/campaigns/{id}'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [UpdateCampaignIn] updateCampaignIn (required):
  Future<AdCampaign?> putAdsCampaignsById(String id, UpdateCampaignIn updateCampaignIn,) async {
    final response = await putAdsCampaignsByIdWithHttpInfo(id, updateCampaignIn,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
