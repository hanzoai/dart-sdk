...
class EvalApi {
  EvalApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> deleteEvalDatasetsByNameWithHttpInfo(String name,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/datasets/{name}'
  ...
  Future<Response> getEvalDatasetsWithHttpInfo({ int? limit, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/datasets';
  ...
  /// * [int] limit:
  ///   Limit caps the rows returned. It defaults to 100 and is capped at 500; a non-positive or unparseable value falls back to the default rather than failing, because a typo about paging is not a reason to refuse a read.
  Future<DatasetList?> getEvalDatasets({ int? limit, }) async {
    final response = await getEvalDatasetsWithHttpInfo( limit: limit, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] name (required):
  ///   Name is the dataset the URL names.
  Future<Response> getEvalDatasetsByNameWithHttpInfo(String name,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/datasets/{name}'
      .replaceAll('{name}', name);
  ...
  /// * [String] name (required):
  ///   Name is the dataset the URL names.
  Future<DatasetView?> getEvalDatasetsByName(String name,) async {
    final response = await getEvalDatasetsByNameWithHttpInfo(name,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [int] limit:
  Future<Response> getEvalDatasetsByNameItemsWithHttpInfo(String name, { int? limit, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/datasets/{name}/items'
      .replaceAll('{name}', name);
  ...
  ///
  /// * [int] limit:
  Future<ItemList?> getEvalDatasetsByNameItems(String name, { int? limit, }) async {
    final response = await getEvalDatasetsByNameItemsWithHttpInfo(name,  limit: limit, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] limit:
  ///   Limit caps the rows returned. It defaults to 100 and is capped at 500; a non-positive or unparseable value falls back to the default rather than failing, because a typo about paging is not a reason to refuse a read.
  Future<Response> getEvalEvaluatorsWithHttpInfo({ int? limit, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/evaluators';
  ...
  /// * [int] limit:
  ///   Limit caps the rows returned. It defaults to 100 and is capped at 500; a non-positive or unparseable value falls back to the default rather than failing, because a typo about paging is not a reason to refuse a read.
  Future<EvaluatorList?> getEvalEvaluators({ int? limit, }) async {
    final response = await getEvalEvaluatorsWithHttpInfo( limit: limit, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> getEvalMetricsWithHttpInfo({ String? range, String? interval, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/metrics';
  ...
  /// * [String] interval:
  ///   Interval overrides the bucket the series is grouped into: \"hour\" or \"day\". Any other value leaves the range's own default in place.
  Future<Board?> getEvalMetrics({ String? range, String? interval, }) async {
    final response = await getEvalMetricsWithHttpInfo( range: range, interval: interval, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] limit:
  ///   Limit caps the rows returned. It defaults to 100 and is capped at 500; a non-positive or unparseable value falls back to the default rather than failing, because a typo about paging is not a reason to refuse a read.
  Future<Response> getEvalRubricsWithHttpInfo({ int? limit, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/rubrics';
  ...
  /// * [int] limit:
  ///   Limit caps the rows returned. It defaults to 100 and is capped at 500; a non-positive or unparseable value falls back to the default rather than failing, because a typo about paging is not a reason to refuse a read.
  Future<ScoreConfigList?> getEvalRubrics({ int? limit, }) async {
    final response = await getEvalRubricsWithHttpInfo( limit: limit, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [int] limit:
  Future<Response> getEvalRunsWithHttpInfo({ String? datasetName, int? limit, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/runs';
  ...
  ///
  /// * [int] limit:
  Future<Runs?> getEvalRuns({ String? datasetName, int? limit, }) async {
    final response = await getEvalRunsWithHttpInfo( datasetName: datasetName, limit: limit, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [int] limit:
  Future<Response> getEvalScoresWithHttpInfo({ String? name, String? runName, String? traceId, int? limit, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/scores';
  ...
  ///
  /// * [int] limit:
  Future<ScoreList?> getEvalScores({ String? name, String? runName, String? traceId, int? limit, }) async {
    final response = await getEvalScoresWithHttpInfo( name: name, runName: runName, traceId: traceId, limit: limit, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [int] limit:
  Future<Response> getEvalTracesWithHttpInfo({ String? sessionId, String? runName, String? datasetName, int? limit, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/traces';
  ...
  ///
  /// * [int] limit:
  Future<TraceList?> getEvalTraces({ String? sessionId, String? runName, String? datasetName, int? limit, }) async {
    final response = await getEvalTracesWithHttpInfo( sessionId: sessionId, runName: runName, datasetName: datasetName, limit: limit, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postEvalDatasetsWithHttpInfo(DatasetReq datasetReq,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/datasets';
  ...
  ///
  /// * [DatasetReq] datasetReq (required):
  Future<DatasetView?> postEvalDatasets(DatasetReq datasetReq,) async {
    final response = await postEvalDatasetsWithHttpInfo(datasetReq,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postEvalDatasetsByNameItemsWithHttpInfo(String name, ItemReq itemReq,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/datasets/{name}/items'
      .replaceAll('{name}', name);
  ...
  ///
  /// * [ItemReq] itemReq (required):
  Future<ItemView?> postEvalDatasetsByNameItems(String name, ItemReq itemReq,) async {
    final response = await postEvalDatasetsByNameItemsWithHttpInfo(name, itemReq,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postEvalEvaluatorsWithHttpInfo(EvaluatorReq evaluatorReq,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/evaluators';
  ...
  ///
  /// * [EvaluatorReq] evaluatorReq (required):
  Future<EvaluatorView?> postEvalEvaluators(EvaluatorReq evaluatorReq,) async {
    final response = await postEvalEvaluatorsWithHttpInfo(evaluatorReq,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postEvalRubricsWithHttpInfo(ScoreConfigReq scoreConfigReq,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/rubrics';
  ...
  ///
  /// * [ScoreConfigReq] scoreConfigReq (required):
  Future<ScoreConfigView?> postEvalRubrics(ScoreConfigReq scoreConfigReq,) async {
    final response = await postEvalRubricsWithHttpInfo(scoreConfigReq,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postEvalRunsWithHttpInfo(RunRequest runRequest, { String? authorization, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/runs';
  ...
  ///
  /// * [String] authorization:
  Future<RunSummary?> postEvalRuns(RunRequest runRequest, { String? authorization, }) async {
    final response = await postEvalRunsWithHttpInfo(runRequest,  authorization: authorization, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postEvalScoresWithHttpInfo(ScoreReq scoreReq,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/eval/scores';
  ...
  ///
  /// * [ScoreReq] scoreReq (required):
  Future<ScoreView?> postEvalScores(ScoreReq scoreReq,) async {
    final response = await postEvalScoresWithHttpInfo(scoreReq,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
