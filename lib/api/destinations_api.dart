...
class DestinationsApi {
  DestinationsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> deleteDestinationsByPlatformWithHttpInfo(String platform,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/destinations/{platform}'
  ...
  /// * [String] platform (required):
  ///   Platform is the destination to act on, from the path: ga4 | meta | tiktok | linkedin | x | reddit | posthog | umami.
  Future<DestinationDisconnected?> deleteDestinationsByPlatform(String platform,) async {
    final response = await deleteDestinationsByPlatformWithHttpInfo(platform,);
  ...
  ///
  /// Note: This method returns the HTTP [Response].
  Future<Response> getDestinationsWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/v1/destinations';
  ...
  ///
  /// Reports every destination this deployment can forward to, each with the caller org's connection state: whether it is connected, whether it is enabled, whether a credential resolves right now, and the config fields the console renders for it.
  Future<DestinationList?> getDestinations() async {
    final response = await getDestinationsWithHttpInfo();
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] platform (required):
  ///   Platform is the destination to act on, from the path: ga4 | meta | tiktok | linkedin | x | reddit | posthog | umami.
  Future<Response> getDestinationsByPlatformWithHttpInfo(String platform,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/destinations/{platform}'
      .replaceAll('{platform}', platform);
  ...
  /// * [String] platform (required):
  ///   Platform is the destination to act on, from the path: ga4 | meta | tiktok | linkedin | x | reddit | posthog | umami.
  Future<DestinationStatus?> getDestinationsByPlatform(String platform,) async {
    final response = await getDestinationsByPlatformWithHttpInfo(platform,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postDestinationsByPlatformWithHttpInfo(String platform, { Map<String, Object>? requestBody, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/destinations/{platform}'
      .replaceAll('{platform}', platform);
  ...
  ///
  /// * [Map<String, Object>] requestBody:
  Future<DestinationStatus?> postDestinationsByPlatform(String platform, { Map<String, Object>? requestBody, }) async {
    final response = await postDestinationsByPlatformWithHttpInfo(platform,  requestBody: requestBody, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] platform (required):
  ///   Platform is the destination to act on, from the path: ga4 | meta | tiktok | linkedin | x | reddit | posthog | umami.
  Future<Response> postDestinationsByPlatformTestWithHttpInfo(String platform,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/destinations/{platform}/test'
      .replaceAll('{platform}', platform);
  ...
  /// * [String] platform (required):
  ///   Platform is the destination to act on, from the path: ga4 | meta | tiktok | linkedin | x | reddit | posthog | umami.
  Future<DestinationTest?> postDestinationsByPlatformTest(String platform,) async {
    final response = await postDestinationsByPlatformTestWithHttpInfo(platform,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
