...
class WebhooksApi {
  ...
  ///
  /// * [String] id (required):
  Future<Response> deleteWebhooksByIdWithHttpInfo(String id,) async {
  ...
  ///
  /// * [String] id (required):
  Future<void> deleteWebhooksById(String id,) async {
    final response = await deleteWebhooksByIdWithHttpInfo(id,);
  ...
  ///
  /// Returns every webhook endpoint the caller's org has registered, newest first, each with its 7-day delivery and failure counts. Signing secrets are redacted here — a secret leaves the server only on create and on rotate. The listing is physically org-scoped, so another tenant's endpoints are not reachable from this route at all.
  Future<EndpointList?> getWebhooks() async {
  ...
  ///
  /// * [String] id (required):
  Future<Response> getWebhooksByIdWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/webhooks/{id}'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [String] id (required):
  Future<Endpoint?> getWebhooksById(String id,) async {
    final response = await getWebhooksByIdWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> getWebhooksByIdDeliveriesWithHttpInfo(String id, { int? limit, String? status, }) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/webhooks/{id}/deliveries'
      .replaceAll('{id}', id);
  ...
  /// * [String] status:
  ///   Status narrows the log to one outcome: \"ok\", \"retrying\" or \"failed\". Empty returns every attempt.
  Future<DeliveryList?> getWebhooksByIdDeliveries(String id, { int? limit, String? status, }) async {
    final response = await getWebhooksByIdDeliveriesWithHttpInfo(id,  limit: limit, status: status, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postWebhooksWithHttpInfo(CreateEndpointIn createEndpointIn,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/webhooks';
  ...
  ///
  /// * [CreateEndpointIn] createEndpointIn (required):
  Future<Endpoint?> postWebhooks(CreateEndpointIn createEndpointIn,) async {
    final response = await postWebhooksWithHttpInfo(createEndpointIn,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [String] id (required):
  Future<Response> postWebhooksByIdSecretWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/webhooks/{id}/secret'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [String] id (required):
  Future<Endpoint?> postWebhooksByIdSecret(String id,) async {
    final response = await postWebhooksByIdSecretWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [String] id (required):
  Future<Response> postWebhooksByIdTestWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [String] id (required):
  Future<TestResult?> postWebhooksByIdTest(String id,) async {
    final response = await postWebhooksByIdTestWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> putWebhooksByIdWithHttpInfo(String id, UpdateEndpointIn updateEndpointIn,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/webhooks/{id}'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [UpdateEndpointIn] updateEndpointIn (required):
  Future<Endpoint?> putWebhooksById(String id, UpdateEndpointIn updateEndpointIn,) async {
    final response = await putWebhooksByIdWithHttpInfo(id, updateEndpointIn,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
