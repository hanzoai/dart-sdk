...
class WalletsApi {
  ...
  Future<Response> getWalletsWithHttpInfo({ String? project, String? agent, String? account, }) async {
  ...
  /// * [String] account:
  ///   Account narrows to wallets under one account id. Must be a url-safe segment.
  Future<WalletList?> getWallets({ String? project, String? agent, String? account, }) async {
    final response = await getWalletsWithHttpInfo( project: project, agent: agent, account: account, );
  ...
  ///
  /// Note: This method returns the HTTP [Response].
  Future<Response> getWalletsAccountsWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/v1/wallets/accounts';
  ...
  ///
  /// Returns the caller org's wallet accounts, newest first. Accounts are physically org-scoped, so another tenant's are not reachable from here.
  Future<AccountList?> getWalletsAccounts() async {
    final response = await getWalletsAccountsWithHttpInfo();
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [String] id (required):
  Future<Response> getWalletsByIdWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/wallets/{id}'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [String] id (required):
  Future<Wallet?> getWalletsById(String id,) async {
    final response = await getWalletsByIdWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postWalletsWithHttpInfo(CreateWalletIn createWalletIn,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/wallets';
  ...
  ///
  /// * [CreateWalletIn] createWalletIn (required):
  Future<Wallet?> postWallets(CreateWalletIn createWalletIn,) async {
    final response = await postWalletsWithHttpInfo(createWalletIn,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postWalletsAccountsWithHttpInfo(CreateAccountIn createAccountIn,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/wallets/accounts';
  ...
  ///
  /// * [CreateAccountIn] createAccountIn (required):
  Future<WalletAccount?> postWalletsAccounts(CreateAccountIn createAccountIn,) async {
    final response = await postWalletsAccountsWithHttpInfo(createAccountIn,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [String] id (required):
  Future<Response> postWalletsByIdKeysWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/wallets/{id}/keys'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [String] id (required):
  Future<Wallet?> postWalletsByIdKeys(String id,) async {
    final response = await postWalletsByIdKeysWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postWalletsByIdSignWithHttpInfo(String id, SignIn signIn,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/wallets/{id}/sign'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [SignIn] signIn (required):
  Future<Signature?> postWalletsByIdSign(String id, SignIn signIn,) async {
    final response = await postWalletsByIdSignWithHttpInfo(id, signIn,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postWalletsByIdTransactionsWithHttpInfo(String id, SafeTxIn safeTxIn,) async {
    // ignore: prefer_const_declarations
    final path = r'/v1/wallets/{id}/transactions'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [SafeTxIn] safeTxIn (required):
  Future<SafeProposal?> postWalletsByIdTransactions(String id, SafeTxIn safeTxIn,) async {
    final response = await postWalletsByIdTransactionsWithHttpInfo(id, safeTxIn,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
