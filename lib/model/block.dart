...
class Block {
  ...
  int get hashCode =>
    ...
    (textEn == null ? 0 : textEn!.hashCode) +
    (type == null ? 0 : type!.hashCode);

  @override
  String toString() => 'Block[prompt=$prompt, state=$state, text=$text, textEn=$textEn, type=$type]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Block[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Block[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Block(
        ...
        textEn: mapValueOfType<String>(json, r'textEn'),
