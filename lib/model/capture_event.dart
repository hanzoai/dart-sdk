...
class CaptureEvent {
  /// Returns a new [CaptureEvent] instance.
  CaptureEvent({
    this.anonymousId,
    this.channel,
    this.clip,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CaptureEvent &&
  ...
  int get hashCode =>
    ...
    (anonymousId == null ? 0 : anonymousId!.hashCode) +
    (channel == null ? 0 : channel!.hashCode) +
    (clip == null ? 0 : clip!.hashCode) +
    ...
    (signupWeek == null ? 0 : signupWeek!.hashCode) +
    ...
    (utm == null ? 0 : utm!.hashCode);

  @override
  String toString() => 'CaptureEvent[anonymousId=$anonymousId, channel=$channel, clip=$clip, currency=$currency, distinctId=$distinctId, environment=$environment, error=$error, event=$event, groupId=$groupId, groupType=$groupType, kind=$kind, level=$level, library_=$library_, libraryVersion=$libraryVersion, log=$log, messageId=$messageId, metric=$metric, path=$path, personId=$personId, product=$product, productId=$productId, properties=$properties, quantity=$quantity, refCode=$refCode, referrer=$referrer, release=$release, resource=$resource, revenue=$revenue, service=$service, sessionId=$sessionId, signupWeek=$signupWeek, site=$site, span=$span, spanId=$spanId, timestamp=$timestamp, traceId=$traceId, type=$type, url=$url, utm=$utm]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
    if (this.anonymousId != null) {
      json[r'anonymousId'] = this.anonymousId;
    } else {
      json[r'anonymousId'] = null;
    }
    ...
    if (this.signupWeek != null) {
      json[r'signupWeek'] = this.signupWeek;
    } else {
      json[r'signupWeek'] = null;
    }
    if (this.site != null) {
  ...
  /// Returns a new [CaptureEvent] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CaptureEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CaptureEvent[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CaptureEvent[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CaptureEvent(
        ...
        clip: ClipBody.fromJson(json[r'clip']),
        ...
        log: LogBody.fromJson(json[r'log']),
        messageId: mapValueOfType<String>(json, r'messageId'),
        metric: MetricBody.fromJson(json[r'metric']),
        ...
        signupWeek: mapValueOfType<String>(json, r'signupWeek'),
        site: mapValueOfType<String>(json, r'site'),
        span: SpanBody.fromJson(json[r'span']),
        spanId: mapValueOfType<String>(json, r'spanId'),
        timestamp: mapValueOfType<String>(json, r'timestamp'),
        traceId: mapValueOfType<String>(json, r'traceId'),
        type: mapValueOfType<String>(json, r'type'),
        url: mapValueOfType<String>(json, r'url'),
        utm: UTM.fromJson(json[r'utm']),
      );
    }
    return null;
  }

  static List<CaptureEvent> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CaptureEvent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CaptureEvent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CaptureEvent> mapFromJson(dynamic json) {
    final map = <String, CaptureEvent>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CaptureEvent.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CaptureEvent-objects as value to a dart map
  static Map<String, List<CaptureEvent>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CaptureEvent>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CaptureEvent.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
