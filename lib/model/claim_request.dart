...
class ClaimRequest {
  ...
  @override
  String toString() => 'ClaimRequest[code=$code]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ClaimRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ClaimRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
