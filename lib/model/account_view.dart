...
class AccountView {
  ...
  @override
  String toString() => 'AccountView[address=$address, balanceCents=$balanceCents]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AccountView[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AccountView[$key]" has a null value in JSON.');
        });
        return true;
      }());
