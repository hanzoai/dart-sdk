...
class ActivityPoint {
  /// Returns a new [ActivityPoint] instance.
  ActivityPoint({
    this.costCents,
    this.day,
    this.requests,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ActivityPoint &&
  ...
  @override
  String toString() => 'ActivityPoint[costCents=$costCents, day=$day, requests=$requests, tokens=$tokens]';
  ...
  /// Returns a new [ActivityPoint] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ActivityPoint? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ActivityPoint[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ActivityPoint[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ActivityPoint> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ActivityPoint>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ActivityPoint.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ActivityPoint> mapFromJson(dynamic json) {
    final map = <String, ActivityPoint>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ActivityPoint.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ActivityPoint-objects as value to a dart map
  static Map<String, List<ActivityPoint>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ActivityPoint>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ActivityPoint.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
