...
class ReportReq {
  /// Returns a new [ReportReq] instance.
  ReportReq({
    this.account,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ReportReq &&
  ...
  /// Returns a new [ReportReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ReportReq? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ReportReq[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ReportReq[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ReportReq(
        ...
        samples: SampleReq.listFromJson(json[r'samples']),
  ...
  static List<ReportReq> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ReportReq>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ReportReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ReportReq> mapFromJson(dynamic json) {
    final map = <String, ReportReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ReportReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ReportReq-objects as value to a dart map
  static Map<String, List<ReportReq>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ReportReq>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ReportReq.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
