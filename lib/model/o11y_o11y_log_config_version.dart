...
class O11yO11yLogConfigVersion {
  /// Returns a new [O11yO11yLogConfigVersion] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is O11yO11yLogConfigVersion &&
    other.config == config &&
  ...
  @override
  String toString() => 'O11yO11yLogConfigVersion[config=$config, createdAt=$createdAt, createdBy=$createdBy, createdByName=$createdByName, deployResult=$deployResult, deploySequence=$deploySequence, deployStatus=$deployStatus, elementType=$elementType, id=$id, lastHash=$lastHash, orgId=$orgId, updatedAt=$updatedAt, updatedBy=$updatedBy, version=$version]';
  ...
  /// Returns a new [O11yO11yLogConfigVersion] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static O11yO11yLogConfigVersion? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "O11yO11yLogConfigVersion[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "O11yO11yLogConfigVersion[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return O11yO11yLogConfigVersion(
  ...
  static List<O11yO11yLogConfigVersion> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <O11yO11yLogConfigVersion>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = O11yO11yLogConfigVersion.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, O11yO11yLogConfigVersion> mapFromJson(dynamic json) {
    final map = <String, O11yO11yLogConfigVersion>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = O11yO11yLogConfigVersion.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of O11yO11yLogConfigVersion-objects as value to a dart map
  static Map<String, List<O11yO11yLogConfigVersion>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<O11yO11yLogConfigVersion>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = O11yO11yLogConfigVersion.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
