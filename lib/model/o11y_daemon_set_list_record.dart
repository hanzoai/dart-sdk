...
class O11yDaemonSetListRecord {
  /// Returns a new [O11yDaemonSetListRecord] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is O11yDaemonSetListRecord &&
    other.availableNodes == availableNodes &&
  ...
  int get hashCode =>
    ...
    (availableNodes == null ? 0 : availableNodes!.hashCode) +
  ...
  @override
  String toString() => 'O11yDaemonSetListRecord[availableNodes=$availableNodes, cpuLimit=$cpuLimit, cpuRequest=$cpuRequest, cpuUsage=$cpuUsage, daemonSetName=$daemonSetName, desiredNodes=$desiredNodes, memoryLimit=$memoryLimit, memoryRequest=$memoryRequest, memoryUsage=$memoryUsage, meta=$meta, restarts=$restarts]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
    if (this.availableNodes != null) {
      json[r'availableNodes'] = this.availableNodes;
    } else {
      json[r'availableNodes'] = null;
    }
  ...
  /// Returns a new [O11yDaemonSetListRecord] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static O11yDaemonSetListRecord? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "O11yDaemonSetListRecord[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "O11yDaemonSetListRecord[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<O11yDaemonSetListRecord> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <O11yDaemonSetListRecord>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = O11yDaemonSetListRecord.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, O11yDaemonSetListRecord> mapFromJson(dynamic json) {
    final map = <String, O11yDaemonSetListRecord>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = O11yDaemonSetListRecord.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of O11yDaemonSetListRecord-objects as value to a dart map
  static Map<String, List<O11yDaemonSetListRecord>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<O11yDaemonSetListRecord>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = O11yDaemonSetListRecord.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
