...
class O11yO11yTagFilter {
  /// Returns a new [O11yO11yTagFilter] instance.
  O11yO11yTagFilter({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is O11yO11yTagFilter &&
  ...
  @override
  String toString() => 'O11yO11yTagFilter[boolValues=$boolValues, key=$key, numberValues=$numberValues, operator_=$operator_, stringValues=$stringValues, tagType=$tagType]';
  ...
  /// Returns a new [O11yO11yTagFilter] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static O11yO11yTagFilter? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "O11yO11yTagFilter[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "O11yO11yTagFilter[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return O11yO11yTagFilter(
  ...
  static List<O11yO11yTagFilter> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <O11yO11yTagFilter>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = O11yO11yTagFilter.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, O11yO11yTagFilter> mapFromJson(dynamic json) {
    final map = <String, O11yO11yTagFilter>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = O11yO11yTagFilter.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of O11yO11yTagFilter-objects as value to a dart map
  static Map<String, List<O11yO11yTagFilter>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<O11yO11yTagFilter>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = O11yO11yTagFilter.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
