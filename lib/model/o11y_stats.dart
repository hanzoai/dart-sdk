...
class O11yStats {
  /// Returns a new [O11yStats] instance.
  O11yStats({
  ...
  ///
  String? currentAvgResolutionTime;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  O11ySeries? currentAvgResolutionTimeSeries;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  O11ySeries? currentTriggersSeries;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  O11ySeries? pastAvgResolutionTimeSeries;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is O11yStats &&
  ...
  /// Returns a new [O11yStats] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static O11yStats? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "O11yStats[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "O11yStats[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return O11yStats(
        currentAvgResolutionTime: mapValueOfType<String>(json, r'currentAvgResolutionTime'),
        currentAvgResolutionTimeSeries: O11ySeries.fromJson(json[r'currentAvgResolutionTimeSeries']),
        currentTriggersSeries: O11ySeries.fromJson(json[r'currentTriggersSeries']),
        pastAvgResolutionTime: mapValueOfType<String>(json, r'pastAvgResolutionTime'),
        pastAvgResolutionTimeSeries: O11ySeries.fromJson(json[r'pastAvgResolutionTimeSeries']),
        pastTriggersSeries: O11ySeries.fromJson(json[r'pastTriggersSeries']),
  ...
  static List<O11yStats> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <O11yStats>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = O11yStats.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, O11yStats> mapFromJson(dynamic json) {
    final map = <String, O11yStats>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = O11yStats.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of O11yStats-objects as value to a dart map
  static Map<String, List<O11yStats>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<O11yStats>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = O11yStats.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
