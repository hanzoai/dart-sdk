...
class Workflow {
  ...
  int get hashCode =>
    ...
    (questionTemplate == null ? 0 : questionTemplate!.hashCode) +
    (text == null ? 0 : text!.hashCode) +
    (text2 == null ? 0 : text2!.hashCode);

  @override
  String toString() => 'Workflow[createdTime=$createdTime, displayName=$displayName, message=$message, name=$name, owner=$owner, questionTemplate=$questionTemplate, text=$text, text2=$text2]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.questionTemplate != null) {
      json[r'questionTemplate'] = this.questionTemplate;
    } else {
      json[r'questionTemplate'] = null;
    }
    if (this.text != null) {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Workflow[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Workflow[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Workflow(
        ...
        questionTemplate: mapValueOfType<String>(json, r'questionTemplate'),
        text: mapValueOfType<String>(json, r'text'),
        text2: mapValueOfType<String>(json, r'text2'),
      );
    }
    return null;
  }
