...
class ClauseCoverage {
  /// Returns a new [ClauseCoverage] instance.
  ClauseCoverage({
    this.automated,
    this.clauses = const [],
    this.edition,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ClauseCoverage &&
  ...
  @override
  String toString() => 'ClauseCoverage[automated=$automated, clauses=$clauses, edition=$edition, framework=$framework, generated=$generated, name=$name, none=$none, note=$note, partial=$partial, publisher=$publisher, statement=$statement, total=$total, unit=$unit, units=$units, version=$version]';
  ...
  /// Returns a new [ClauseCoverage] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ClauseCoverage? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ClauseCoverage[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ClauseCoverage[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ClauseCoverage(
        ...
        clauses: ClauseRow.listFromJson(json[r'clauses']),
  ...
  static List<ClauseCoverage> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ClauseCoverage>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ClauseCoverage.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ClauseCoverage> mapFromJson(dynamic json) {
    final map = <String, ClauseCoverage>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ClauseCoverage.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ClauseCoverage-objects as value to a dart map
  static Map<String, List<ClauseCoverage>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ClauseCoverage>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ClauseCoverage.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
