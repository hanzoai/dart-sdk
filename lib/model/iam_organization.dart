...
class IamOrganization {
  /// Returns a new [IamOrganization] instance.
  IamOrganization({
  ...
  /// Returns a new [IamOrganization] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IamOrganization? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IamOrganization[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IamOrganization[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IamOrganization> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IamOrganization>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IamOrganization.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IamOrganization> mapFromJson(dynamic json) {
    final map = <String, IamOrganization>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IamOrganization.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IamOrganization-objects as value to a dart map
  static Map<String, List<IamOrganization>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IamOrganization>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IamOrganization.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
