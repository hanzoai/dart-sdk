...
class ReadingReq {
  /// Returns a new [ReadingReq] instance.
  ReadingReq({
    this.account,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ReadingReq &&
  ...
  /// Returns a new [ReadingReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ReadingReq? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ReadingReq[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ReadingReq[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ReadingReq> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ReadingReq>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ReadingReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ReadingReq> mapFromJson(dynamic json) {
    final map = <String, ReadingReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ReadingReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ReadingReq-objects as value to a dart map
  static Map<String, List<ReadingReq>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ReadingReq>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ReadingReq.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
