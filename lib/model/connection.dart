...
class Connection {
  ...
  int get hashCode =>
    ...
    (commandCount == null ? 0 : commandCount!.hashCode) +
  ...
  @override
  String toString() => 'Connection[clientIp=$clientIp, clientIpDesc=$clientIpDesc, code=$code, commandCount=$commandCount, connectionId=$connectionId, createdTime=$createdTime, creator=$creator, endTime=$endTime, height=$height, message=$message, mode=$mode, name=$name, node=$node, operations=$operations, owner=$owner, protocol=$protocol, recording=$recording, reviewed=$reviewed, startTime=$startTime, status=$status, userAgent=$userAgent, userAgentDesc=$userAgentDesc, width=$width]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.commandCount != null) {
      json[r'commandCount'] = this.commandCount;
    } else {
      json[r'commandCount'] = null;
    }
  ...
  static Connection? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Connection(
        ...
        commandCount: mapValueOfType<int>(json, r'commandCount'),
        ...
        recording: mapValueOfType<String>(json, r'recording'),
