...
class IamRole {
  /// Returns a new [IamRole] instance.
  IamRole({
    this.createdAt,
    this.createdTime,
    this.deleted,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IamRole &&
  ...
  /// Returns a new [IamRole] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IamRole? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IamRole[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IamRole[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IamRole> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IamRole>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IamRole.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IamRole> mapFromJson(dynamic json) {
    final map = <String, IamRole>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IamRole.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IamRole-objects as value to a dart map
  static Map<String, List<IamRole>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IamRole>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IamRole.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
